...
class App extends Component {
  ...
  setAccountList(accountList) {
    console.log( "ACCOUNT LIST IS NEXT" );
  ...
  render() {
    ...
    if ( ! accessToken ) {
      return (
        <div>
          <a href="https://app.youneedabudget.com/oauth/authorize?client_id=70358bfd41a2fadf29be9211bbf672b434ff7ae49dd3d6bf8b011afbe35f4e5a&redirect_uri=http://localhost:3000&response_type=token">
